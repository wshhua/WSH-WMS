...
export default {
  ...
  methods: {
    ...
    exitScanClick () {
      this.router.push('/salesReturnList?orderId=' + this.orderCode + '&orderType=' + this.orderType)
    },
    ...
    gainOrderDetail () {
      ...
      // 获取清单数据
      var loginUrl1 = this.Gbl.commonUrl + '/transasctions/getTransationDetailList' + this.Gbl.commonVariaList + '&tranid=' + this.orderCode + '&transactionType=SO_RETURN'
      this.axios({
        method: 'get',
        url: loginUrl1,
        data: '',
