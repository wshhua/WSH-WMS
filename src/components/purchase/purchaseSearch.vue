...
export default {
  ...
  methods: {
    ...
    gainAllotList () {
      ...
      // 获取清单数据
      var loginUrl1 = this.Gbl.commonUrl + '/transasctions/getTranidList' + this.Gbl.commonVariaList + '&transactionType=PO'
      this.axios({
        method: 'get',
        url: loginUrl1,
        data: '',
      ...
      // 获取清单数据
      var loginUrl2 = this.Gbl.commonUrl + '/transasctions/getTranidList' + this.Gbl.commonVariaList + '&transactionType=ITEM_RECEIPT_PLAN'
      this.axios({
        method: 'get',
        url: loginUrl2,
        data: '',
      ...
      // 获取清单数据
      var loginUrl3 = this.Gbl.commonUrl + '/transasctions/getTranidList' + this.Gbl.commonVariaList + '&transactionType=TRACKING_NUMBER&entry=PO'
      this.axios({
        method: 'get',
        url: loginUrl3,
        data: '',
    ...
    searchClick () {
      ...
      if (this.purchaseNum === '') {
        ...
        this.router.push('/purchaseDetail?orderId=' + this.purchaseNum + '&orderType=' + this.orderType)
      } else if (!this.isCanSubmit) {
